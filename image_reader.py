...
@click.option('--list-fname', type=click.Path(exists=True),
              default='/home/v-yurzho/benchmark_RELEASE/dataset/train.txt')
@click.option('--img-root', type=click.Path(exists=True),
              default='/home/v-yurzho/benchmark_RELEASE/dataset/img')
@click.option('--mask-root', type=click.Path(exists=True),
              default='/home/v-yurzho/benchmark_RELEASE/dataset/pngs')
